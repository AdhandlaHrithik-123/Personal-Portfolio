      ...
      <div className="portfolio--container-box">
        ...
        <div>
          <button className="btn btn-github">
            ...
            <a href="https://github.com/AdhandlaHrithik-123">Visit My Github</a>
          </button>
        </div>
      </div>
          ...
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link">
                ...
                {item.id=="1"&&<a href="https://github.com/AdhandlaHrithik-123/Coffee-Day">{item.link}</a>}
                {item.id=="1"&&<a href="https://cafe-coffee-day-45f37.firebaseapp.com/">{item.live}</a>}
                {item.id=="2"&&<a href="https://github.com/AdhandlaHrithik-123/homescreen-hungry">{item.link}</a>}
                {item.id=="2"&&<a href="https://adhandlahrithik-123.github.io/homescreen-hungry/">{item.live}</a>}
                {item.id=="3"&&<a href="https://github.com/AdhandlaHrithik-123/JS-Weather-App">{item.link}</a>}
                {item.id=="3"&&<a href="https://adhandlahrithik-123.github.io/JS-Weather-App/">{item.live}</a>}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
